                            ...
                            <div class="row">
                                <div class="col-3">
                                    <div class="list-group" id="list-tab" role="tablist">
                                        ...
                                        <a class="list-group-item list-group-item-action"
                                           id="list-category-product-slider-2" data-toggle="list"
                                           href="#category-product-slider-2" role="tab">Default Tab</a>
                                    </div>
                                </div>
                                <div class="col-9">
                                    <div class="tab-content" id="nav-tabContent">
                                        ...
                                        @include( 'admin.home-page-settings.sections.category-product-slider-2' )
                                    </div>
                                </div>
                            </div>
                        </div>
